...
proc esm data=Work.preProcessedData back=0 lead=5 plot=(corr errors 
		modelforecasts) 
		outest=consume.econsume_dob_est 
		outstat=consume.econsume_dob_fit 
		outfor=consume.econsume_dob_forecast 
		outsum=consume.econsume_dob_summary;
	by country;
	id date interval=day;
	forecast econsume / alpha=0.05 model=double transform=none;
run;
