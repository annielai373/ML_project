...
proc esm data=Work.preProcessedData back=0 lead=5 plot=(corr errors 
		modelforecasts) 
		outest=consume.econsume_lr_est 
		outstat=consume.econsume_lr_fit 
		outfor=consume.econsume_lr_forecast 
		outsum=consume.econsume_lr_summary;
	by country;
	id date interval=day;
	forecast econsume / alpha=0.05 model=linear transform=none;
run;
